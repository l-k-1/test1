...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 17 2018 г., 20:58
...
(1, 'Блог', 0, 'blog', '2018-02-16 22:00:00', NULL),
(2, 'Компьютеры', 1, 'computers', '2018-02-16 22:00:00', NULL),
(3, 'Интересное', 1, 'iteresting', '2018-02-16 22:00:00', NULL),
(4, 'Советы', 1, 'soveti', '2018-02-16 22:00:00', NULL);
...
(1, 'Привет. Как дела ???', 'Алексей', 'alexey@ukr.net', 'alexey.ua', 0, '2018-02-16 22:00:00', NULL, 1, NULL),
(2, 'Все ОК.', '', '', '', 1, '2018-02-16 22:00:00', NULL, 1, 1),
(3, 'Что тут написано ???', 'Крот', 'krot@mail.ru', 'krot.ru', 0, '2018-02-16 22:00:00', NULL, 2, NULL);
...
(1, 'Brand Identity', 'brand-identity', '2018-02-16 22:00:00', NULL);
...
(1, 'Главная', 'http://corporate.loc', 0, '2018-02-16 22:00:00', NULL),
(2, 'Блог', 'http://corporate.loc/articles', 0, '2018-02-16 22:00:00', NULL),
(3, 'Компьютеры', 'http://corporate.loc/articles/cat/computers', 2, '2018-02-16 22:00:00', NULL),
(4, 'Интересное', 'http://corporate.loc/articles/cat/iteresting', 2, '2018-02-16 22:00:00', NULL),
(5, 'Советы', 'http://corporate.loc/articles/cat/soveti', 2, '2018-02-16 22:00:00', NULL),
(6, 'Портфолио', 'http://corporate.loc/portfolios', 0, '2018-02-16 22:00:00', NULL),
(7, 'Контакты', 'http://corporate.loc/contacts', 0, '2018-02-16 22:00:00', NULL);
...
(3, '2017_10_02_162655_CreateArticlesTable', 1),
(4, '2017_10_08_103200_CreatePortfoliosTable', 1),
(5, '2017_10_08_105656_CreateFiltersTable', 1),
(6, '2017_10_08_111332_CreateCommentsTable', 1),
(7, '2017_10_08_112542_CreateSlidersTable', 1),
(8, '2017_10_08_112945_CreateMenusTable', 1),
(9, '2017_10_08_113323_CreateCategoriesTable', 1),
(10, '2017_10_08_120747_ChangeArticlesTable', 1),
(11, '2017_10_08_122330_ChangeCommentsTable', 1),
(12, '2017_10_08_132510_ChangePortfoliosTable', 1);
...
(1, 'xx.jpg', '<h2 style=\"color:#fff\">CORPORATE, MULTIPURPOSE.. <br /><span>PINK RIO</span></h2>', 'Nam id quam a odio euismod pellentesque. Etiam congue rutrum risus non vestibulum. Quisque a diam at ligula blandit consequat. Mauris ac mi velit, a tempor neque\r\n', '2018-02-16 22:00:00', NULL),
(2, '00314.jpg', '<h2 style=\"color:#fff\">PINKRIO. <span>STRONG AND POWERFUL.</span></h2>', 'Nam id quam a odio euismod pellentesque. Etiam congue rutrum risus non vestibulum. Quisque a diam at ligula blandit consequat. Mauris ac mi velit, a tempor neque', '2018-02-16 22:00:00', NULL),
(3, 'dd.jpg', '<h2 style=\"color:#fff\">PINKRIO. <span>STRONG AND POWERFUL.</span></h2>', 'Nam id quam a odio euismod pellentesque. Etiam congue rutrum risus non vestibulum. Quisque a diam at ligula blandit consequat. Mauris ac mi velit, a tempor neque', '2018-02-16 22:00:00', NULL);
...
(1, 'User', 'user@mail.ru', '$2y$10$lrVeTTG3YZP1YqP5Q.j2ROBI.RSFytHpawP2It4jZJcQc/Z1YQr1i', 'Hy5uxappbLgyy46XMaEVWb3xKm2fFene1CmuAsuAfxpMFFUbjTGbPKwvLERy', '2018-02-17 14:39:41', '2018-02-17 14:39:41');
